...
\usepackage{vmargin}   
\setmarginsrb{2.5cm}{2.5cm}{2.5cm}{2.5cm}{12pt}{6mm}{6pt}{6mm}
\setpapersize{A4}
\usepackage{fancyhdr}
...
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Input Cells\end{tabular}       & 2                                                                                                               & 2                                                                                                               & 4                                                                                           & 0                                                                                                              \\ \hline
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Output Cells\end{tabular}      & 3                                                                                                               & 3                                                                                                               & 5                                                                                           & 0                                                                                                              \\ \hline
\begin{tabular}[c]{@{}c@{}}Scan-in, Scan-out\\  Length\end{tabular} & 20, 21                                                                                                              & 20, 21                                                                                                              & 20, 21                                                                                          & 20, 20                                                                                                             \\ \hline
\end{tabular}
...
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Output Cells\end{tabular}      & 4                                                                                           & 4                                                                                           & 0                                                                                          \\ \hline
\begin{tabular}[c]{@{}c@{}}Scan-in, Scan-out\\  Length\end{tabular} & 19, 16                                                                                          & 19, 16                                                                                          & 18, 16                                                                                        \\ \hline
\end{tabular}
}
...
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Output Cells\end{tabular}      & 0                                                                                           & 0                                                                                           & 4                                                                                          & 4                                                                     \\ \hline
\begin{tabular}[c]{@{}c@{}}Scan-in, Scan-out\\  Length\end{tabular} & 14, 12                                                                                          & 14, 12                                                                                          & 14, 12                                                                                         & 14, 12                                                                    \\ \hline
\end{tabular}
}
...
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Output Cells\end{tabular}      & 0                                                                                           & 0                                                                                           & 4                                                                                          & 4                                                                     & 0                                 \\ \hline
\begin{tabular}[c]{@{}c@{}}Scan-in, Scan-out\\  Length\end{tabular} & 12                                                                                          & 12                                                                                          & 12                                                                                         & 12                                                                    & 8                                \\ \hline
\end{tabular}
}
...
\begin{tabular}[c]{@{}c@{}}Wrapper\\ Output Cells\end{tabular}      & 0                                                                                           & 0                                                                                           & 4                                                                                          & 4                                                                     & 0                                 & 0                                 \\ \hline
\begin{tabular}[c]{@{}c@{}}Scan-in, Scan-out\\  Length\end{tabular} & 12                                                                                          & 12                                                                                          & 12                                                                                         & 12                                                                    & 8                                & 0                                 \\ \hline
\end{tabular}
}
...
\subsection*{(b)}
\hspace{0.5cm}Knowing the acceptable widths of the wrappers (Arjun said in office-hours that we can only use the sizes from part (a)), and the fact that each of the 8 SOCs are identical, greatly simplified this problem. The following code was used to maximize the minimum wrapper width for this TAM design (minimizing scan-in/scan-out length and therefore minimizing test-time).
...
In the TAM design result, each embedded core wrapper is given their own TAM lines; however, the TAM width is not the same for each core because of the 36-bit TAM width constraint. No wrappers share TAM lines in this case, as preempting tests or testing serially would result in longer maximum test time for the given widths. Four of the wrappers will have a TAM width of 5 and the other will have TAM widths of 4. This ensures the maximum scan-in/scan-out is 14/12 shifts or 27 clock cycles, including a 1 clock cycle capture, corresponding to the BFD optimization in part (a) and assuming one clock cycle per single-bit shift-in/shift-out.
